...
CREATE TABLE IF NOT EXISTS t_gateway_activity (
  ...
  user_action  VARCHAR(8)   NOT NULL CHECK (user_action IN ('CREATE', 'EDIT', 'DELETE', 'OVERRIDE')),
  job_id       VARCHAR(36)  NOT NULL,
  job_start_at TIMESTAMP(6) WITH TIME ZONE NOT NULL,
  job_end_at   TIMESTAMP(6) WITH TIME ZONE NOT NULL,
