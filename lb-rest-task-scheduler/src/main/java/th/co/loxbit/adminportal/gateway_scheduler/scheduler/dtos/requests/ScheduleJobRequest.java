package th.co.loxbit.adminportal.gateway_scheduler.scheduler.dtos.requests;
...
public record ScheduleJobRequest(
    ...
    @NotNull @Size(max = 255, message = "Message must not exceed 255 characters") String message) {
}
